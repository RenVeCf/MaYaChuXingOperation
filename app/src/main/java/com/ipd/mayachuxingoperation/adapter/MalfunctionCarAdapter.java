...
public class MalfunctionCarAdapter extends BaseQuickAdapter<MalfunctionSumBean.DataBean.ListBean, BaseViewHolder> {

    private Context context;

    public MalfunctionCarAdapter(@Nullable List<MalfunctionSumBean.DataBean.ListBean> data, Context context) {
